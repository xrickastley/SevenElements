...
From [Indirect Elemental Damage](../../guide/elements/Elemental%20Combat.md#indirect-elemental-damage), you may have seen that supported items that shoot projectiles like the [Bow](https://minecraft.wiki/w/Bow), [Crossbow](https://minecraft.wiki/w/Crossbow) and [Trident](https://minecraft.wiki/w/Trident) will have their damage be infused with the same Element as the item.

From [Direct Elemental Damage](../../guide/elements/Elemental%20Combat.md#direct-elemental-damage), you may have seen that if damage is dealt directly, it would be infused with the same Element as the item.
