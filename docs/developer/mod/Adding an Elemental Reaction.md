...
Similarly to blocks and items, Elemental Reactions take an `ElementalReaction.Settings` in their constructor, which specify properties of the reaction, such as its [Aura Element](../../guide/elements/Elemental%20Gauge%20Theory.md#elemental-auras-and-the-aura-tax) and [Triggering Element](../../guide/elements/Elemental%20Gauge%20Theory.md#triggering-elements-and-elemental-reactions), priority, etc.
...
- We set the [Reaction Coefficient](../../guide/elements/Elemental%20Gauge%20Theory.md#triggering-elements-and-elemental-reactions) to `1.0`.
...
- `double reducedGauge` is the reduced amount of [gauge units](../../guide/elements/Elemental%20Gauge%20Theory.md#elemental-auras-and-the-aura-tax) from both elemental applications.
- `@Nullable LivingEntity origin` is the living entity that triggered the reaction
	- This is annotated as `@Nullable` since reactions triggered by [Natural Element Sources](../../guide/elements/Elemental%20Combat.md#natural-element-sources) have no `origin`.
