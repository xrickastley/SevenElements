...
Seven Elements expands upon Minecraft's combat, adding an *Elemental* alignment to attacks, which applies the corresponding Element onto entities, triggering various [Elemental Reactions](./elemental_reactions.md) under certain conditions.
...
There are 8 damage types (not to be confused with [Minecraft/Damage type](https://minecraft.wiki/w/Damage_type)), which are composed of [the Seven Elements](./the_seven_elements.md): <span class="pyro">**Pyro**</span>, <span class="hydro">**Hydro**</span>, <span class="anemo">**Anemo**</span>, <span class="electro">**Electro**</span>, <span class="dendro">**Dendro**</span>, <span class="cryo">**Cryo**</span>, <span class="geo">**Geo**</span>, as well as **Physical**, the non-Element damage type. 
...
When using the [Infusion Table](../blocks/infusion_table.md), an item may be infused with an element.

When an item is infused with an element, its elemental infusion is appended at the end of its name. It is also given a static glint with the color of it's infused element, to indicate it's been infused with one.
...
Like [Mob Elemental Damage](#mob-elemental-damage), these elemental damage instances apply **1 [gauge unit](./elemental_gauge_theory.md#elemental-gauge-theory)** of their corresponding Element, given that the element can be an [Aura Element](./elemental_gauge_theory.md#elemental_auras_and_the_aura_tax).
...
Unlike **Genshin Impact**, <span class="dendro">**Dendro DMG**</span> originating from the [Bloom](./elemental_reactions/bloom.md) reactions and its derivatives are **not limited** to **2** per **0.5s**. This means that an entity can take multiple amounts of <span class="dendro">**Dendro DMG**</span> from Bloom-related reactions in a short timeframe without the other damage instances being ignored.