...
The **Shatter** reaction is now triggered **if** the target receives **any** form of <span class="geo">**Geo DMG**</span> **or** when they are hit with an **Axe** or **Pickaxe**, as no concept of "Blunt Attacks" (a.k.a "Heavy Attacks") and "Poise" exists in Minecraft and are not easily addable with respect to other mods.

Unlike **Genshin Impact**, <span class="dendro">**Dendro DMG**</span> originating from the [Bloom](./elemental_reactions/bloom.md) reactions and its derivatives are **not limited** to **2** per **0.5s**. This means that an entity can take multiple amounts of <span class="dendro">**Dendro DMG**</span> in a short timeframe without the other's being ignored.