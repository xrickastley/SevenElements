...
The Frozen state created by the [Frozen](../../wiki/elemental_reactions/Frozen.md) Elemental Reaction is maintained by the <span class="cryo">**Freeze**</span> aura.
...
- Triggers [Shatter](../../wiki/elemental_reactions/Frozen.md#shatter) upon being hit with a <span class="geo">**Geo**</span> attack or a [Heavy Weapon](../../wiki/tags/Item%20tag.md#heavy_weapon).
