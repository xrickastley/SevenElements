...
prev:
    text: 'Commands'
    link: '/wiki/groups/Commands'
---

# /element
<sup>&nbsp; &nbsp; < [Commands](../Commands.md)</sup>

The `/element` command can be used to check, add, remove and modify elements for an living entity, as well as apply elements infusions to items like the [Infusion Table](../../blocks/Infusion%20Table.md).
...
Applies the specified element to the specified target with the specified amount of [gauge units](../../../guide/elements/Elemental%20Gauge%20Theory.md).
...
Applies the specified element to the specified target with the specified amount of [gauge units](../../../guide/elements/Elemental%20Gauge%20Theory.md) that lasts for a maximum of the specified duration, in ticks.
...
Reduces the specified element of the specified target with the specified amount of [gauge units](../../../guide/elements/Elemental%20Gauge%20Theory.md).
...
Applies a random permanent elemental infusion to the target's held item, like using an [Infusion Table](../../blocks/Infusion%20Table.md)
...
- `<gaugeUnits>` being a double (a decimal or whole number) greater than 0.0.
    - (e.g: `1`, `1.5`, `4`)
- `[tag]` being a valid [Internal Cooldown Tag](../../../guide/elements/Internal%20Cooldown.md) string, defaults to the special `none` Internal Cooldown Tag.
    - (e.g: `damage`, `seven-elements:infusion`, `"Custom Infusion Tag"`, `""` (none))
- `[type]` being a valid [Internal Cooldown Type](../../../guide/elements/Internal%20Cooldown.md) id, defaults to `seven-elements:default`.
