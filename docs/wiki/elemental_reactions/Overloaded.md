...
Overloaded is the [Elemental Reaction](../../guide/elements/Elemental%20Reactions.md) triggered when <span class="electro">**Electro**</span> is applied onto an entity already affected by <span class="pyro">**Pyro**</span> or vice versa.
