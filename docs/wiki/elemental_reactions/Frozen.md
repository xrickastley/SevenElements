...
Frozen is the [Elemental Reaction](../../guide/elements/Elemental%20Reactions.md) triggered when <span class="cryo">**Cryo**</span> is applied onto an entity already affected by <span class="hydro">**Hydro**</span> or vice versa.
...
When an entity with the <span class="cryo">**Freeze**</span> aura receives <span class="geo">**Geo DMG**</span> or is hit by a [Heavy Weapon](../tags/Item%20tag.md#heavy_weapon), the [**Shatter**](#shatter) reaction is triggered.
...
Shatter is the [Elemental Reaction](../../guide/elements/Elemental%20Reactions.md) triggered when an entity inflicted with the <span class="cryo">**Freeze**</span> aura receives <span class="geo">**Geo DMG**</span> or is **directly** hit by a [Heavy Weapon](../tags/Item%20tag.md#heavy_weapon).

Shatter **cannot** be triggered directly on the same hit after a <span class="cryo">**Frozen**</span> reaction even when it was triggered by a **direct** hit from a [Heavy Weapon](../tags/Item%20tag.md#heavy_weapon). Shatter can **only** be triggered by a **direct** hit from a [Heavy Weapon](../tags/Item%20tag.md#heavy_weapon) that does **not** trigger the <span class="cryo">**Frozen**</span> reaction on the same hit.
...
- `seven-elements:shatter_heavy` (triggered by being hit with a [Heavy Weapon](../tags/Item%20tag.md#heavy_weapon))
