...
Bloom is the [Elemental Reaction](../../guide/elements/Elemental%20Reactions.md) triggered when <span class="dendro">**Dendro**</span> is applied onto an entity already affected by <span class="hydro">**Hydro**</span> or vice versa.
...
# Hyperbloom
<sup>&nbsp; &nbsp; < [Elemental Reactions](../../guide/elements/Elemental%20Reactions.md)</sup>

Hyperbloom is the [Elemental Reaction](../../guide/elements/Elemental%20Reactions.md) triggered on a [Dendro Core](#dendro-core) when it receives <span class="electro">**Electro DMG**</span>.
...
Burgeon is the [Elemental Reaction](../../guide/elements/Elemental%20Reactions.md) triggered on a [Dendro Core](#dendro-core) when it receives <span class="pyro">**Pyro DMG**</span>.
