...
Melt is the [Elemental Reaction](../../guide/elements/Elemental%20Reactions.md) triggered when <span class="pyro">**Pyro**</span> is applied onto an entity already affected by <span class="cryo">**Cryo**</span> or vice versa.
