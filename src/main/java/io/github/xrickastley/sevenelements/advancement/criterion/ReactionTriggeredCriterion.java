...
public class ReactionTriggeredCriterion extends AbstractCriterion<ReactionTriggeredCriterion.Conditions> {
	...
	public class Conditions extends AbstractCriterionConditions {
		...
		private Conditions(LootContextPredicate player, Optional<RegistryEntryList<ElementalReaction>> elementalReactions, Optional<Element> triggeringElement) {
			super(ReactionTriggeredCriterion.ID, player);
