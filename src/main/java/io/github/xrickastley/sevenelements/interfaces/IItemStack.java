...
public interface IItemStack {
	 ...
	 * This is the unmodified version of {@link ItemStack#getHoverName()}, and should <b>only</b> be
	 ...
	 */
	default Component sevenelements$getTrueName() {
		return null;
	}

	/**
	 * Checks if an elemental glint effect should be applied when the item stack is rendered.
	 * This is affected by the value of the {@link DataComponents#ENCHANTMENT_GLINT_OVERRIDE}
	 * component.
	 *
	 ...
	 * elemental infusion or if the stack contains the {@link DataComponents#EQUIPPABLE}
	 * component.
	 */
