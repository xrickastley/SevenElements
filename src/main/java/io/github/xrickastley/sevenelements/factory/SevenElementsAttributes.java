...
public class SevenElementsAttributes {
	...
	public static void addMultiplicativeLikeAttributes(List<EntityAttribute> attributes) {
		SevenElementsAttributes.MULTIPLICATIVE_LIKE_ATTRIBUTES.addAll(attributes);
	}

	@ApiStatus.Internal
	public static boolean isMultiplicativeLikeAttribute(EntityAttribute attribute) {
