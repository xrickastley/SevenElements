...
public class SmithingAttunementRecipe implements SmithingRecipe {
	...
	public SmithingAttunementRecipe(Identifier id, Ingredient template, Ingredient base, Ingredient addition) {
		this.id = id;
	...
	public static class Serializer implements RecipeSerializer<SmithingAttunementRecipe> {
		public SmithingAttunementRecipe read(Identifier identifier, JsonObject jsonObject) {
			...
			return new SmithingAttunementRecipe(identifier, ingredient, ingredient2, ingredient3);
		}

		public SmithingAttunementRecipe read(Identifier identifier, PacketByteBuf packetByteBuf) {
