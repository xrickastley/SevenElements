package io.github.xrickastley.sevenelements.mixin.client.inject;
...
@Mixin({ ItemRenderState.Glint.class, ItemRenderState.LayerRenderState.class, OrderedRenderCommandQueueImpl.ItemCommand.class })
