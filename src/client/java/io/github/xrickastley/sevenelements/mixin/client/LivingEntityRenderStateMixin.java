...
public class LivingEntityRenderStateMixin implements SevenElementsLivingEntityRenderState {
	...
	public Vec3d sevenelements$boundingBoxLength;
	...
	public void sevenelements$fillRenderState(LivingEntity entity, float tickDelta) {
		...
		this.sevenelements$isDead = entity.isDead();
		this.sevenelements$isClientPlayer = entity == client.player;
		this.sevenelements$boundingBoxLength = new Vec3d(box.getLengthX(), box.getLengthY(), box.getLengthZ());
	...
	@Unique
	@Override
	public Vec3d sevenelements$getBoundingBoxLength() {
