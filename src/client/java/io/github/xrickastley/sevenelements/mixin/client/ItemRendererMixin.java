...
public class ItemRendererMixin {
	...
	private VertexConsumer renderAttunementGlint$2(VertexConsumerProvider vertexConsumers, RenderLayer layer, boolean solid, boolean glint, Operation<VertexConsumer> original, @Local(argsOnly = true) ItemStack itemStack) {
