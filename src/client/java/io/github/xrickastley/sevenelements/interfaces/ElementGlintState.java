...
/**
 * An extension of {@link ItemStackRenderState.FoilType} and {@link ItemStackRenderState.LayerRenderState},
 * allowing elemental glints to work.
 *
 * <p>Unfortunately, {@link ItemStackRenderState.FoilType} is an <b>enum</b>, which means that instances
...
public interface ElementGlintState {
	 ...
	 *
	 * <p>Since {@link ItemStackRenderState.FoilType} is an {@code enum}, this method <b>must</b> be called
