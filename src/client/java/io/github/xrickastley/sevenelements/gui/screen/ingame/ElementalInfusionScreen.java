...
public class ElementalInfusionScreen extends HandledScreen<ElementalInfusionScreenHandler> {
	...
	private static final Identifier INFUSE_LEVEL_ENABLED_TEXTURE = SevenElements.identifier("textures/gui/sprites/container/infusion_table/level_enabled.png");
	private static final Identifier INFUSE_LEVEL_DISABLED_TEXTURE = SevenElements.identifier("textures/gui/sprites/container/infusion_table/level_disabled.png");

	private static final Identifier UNINFUSE_LEVEL_ENABLED_TEXTURE = Identifier.of("minecraft", "textures/gui/sprites/container/enchanting_table/level_2.png");
	private static final Identifier UNINFUSE_LEVEL_DISABLED_TEXTURE = Identifier.of("minecraft", "textures/gui/sprites/container/enchanting_table/level_2_disabled.png");
	...
	private void drawElement(final Element element, final DrawContext context, final int x, final int y) {
		...
		final boolean cantInfuseElement = targetItem.isEmpty()
			|| (ElementalAttunementComponent.hasAttunement(targetItem)
			&& ElementalAttunementComponent.get(targetItem).element() != element);
	...
	private void drawInfuseButton(DrawContext context, final int x, final int y, final int mouseX, final int mouseY) {
		...
		RenderSystem.enableBlend();
		context.drawTexture(texture, x1, y1, 0, 0, width, height, 90, 19);
	...
	private void drawUninfuseButton(DrawContext context, final int x, final int y, final int mouseX, final int mouseY) {
		...
		RenderSystem.enableBlend();
		context.drawTexture(texture, x1, y1, 0, 0, width, height, 90, 19);
		context.drawTexture(expTexture, x2 - 18, y2 - 16, 0, 0, 16, 16, 16, 16);
