...
public final class ElementGlintRenderer {
	...
	public static VertexConsumer getSpecialDisplayGlintConsumer(VertexConsumer original, VertexConsumerProvider provider, RenderLayer layer, MatrixStack.Entry entry, ItemRenderState.Glint glintState) {
